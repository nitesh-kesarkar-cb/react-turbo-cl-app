...
export const questionColumns: ColumnDef<OnboardingQuestion>[] = [
    {
        id: "select",
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <Badge
                    variant="outline"
                    className={typeColor[type] || "bg-gray-50 text-gray-700 border-gray-200"}
                >
                    {type}
                </Badge>
            );
    ...
    },
    {
        ...
        cell: () => (
            <div className="flex gap-3 text-gray-400">
                ...
                <Trash className="h-4 w-4 cursor-pointer hover:text-red-600" />
            </div>
        ),
    },
];

export const QuestionTable = ({ questions }: { questions: OnboardingQuestion[] }) => {
    return (
        <DataTable
